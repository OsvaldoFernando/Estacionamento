										...
										<select class="form-control mensalistas select2" name="mensalidade_mensalista_id" <?php echo (isset($mensalidade) ? 'disabled' : ''); ?>>
											...
											<?php foreach ($mensalistas as $mensalista): ?>
												...
												<?php if (isset($mensalidade)): ?>
													...
													<option value="<?php echo $mensalista->mensalista_id . ' ' . $mensalista->mensalista_dia_vencimento ?>" <?php echo ($mensalista->mensalista_id == $mensalidade->mensalidade_mensalista_id ? 'selected' : '') ?>><?php echo $mensalista->mensalista_nome . '&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;E-mail&nbsp&nbsp;' . $mensalista->mensalista_email; ?></option>

												<?php else: ?>

													<option value="<?php echo $mensalista->mensalista_id . ' ' . $mensalista->mensalista_dia_vencimento ?>"><?php echo $mensalista->mensalista_nome . '&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;E-mail&nbsp&nbsp;' . $mensalista->mensalista_email; ?></option>
